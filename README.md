...
> [涓枃鏂囨。 (Chinese)](README_zh.md) | [Spec Site](https://axisrobo.github.io/aep/)
...
- **4 productized implementations** (TypeScript, Python, Go, Java) 锟-each with runtime daemon, CLI, HTTP API, subscriptions, MCP bridge, and delivery stores
...
- `AGENTS.md` 锟-OpenCode project rules
- `CLAUDE.md` 锟-Claude Code project rules
- `.superpowers/specs/` 锟-Superpowers-backed design specs
- `.superpowers/plans/` 锟-Superpowers-backed execution plans
...
See `examples/` 锟-organized by scene: quickstart, service-client, mcp-bridge, scenarios. Each file is language-suffixed.
