...
- Create: `docs/specs/conformance.md` — protocol-facing conformance level specification.
- Create: `conformance/manifest.json` — shared source of truth mapping fixtures to levels, expectations, and tags.
- Create: `reference/typescript/src/conformance.js` — TypeScript manifest loader and fixture verifier.
- Create: `reference/typescript/src/conformance-cli.js` — command-line wrapper for `npm run conformance`.
- Modify: `reference/typescript/package.json` — add `conformance` script.
- Modify: `reference/typescript/test/fixtures.test.js` — replace hard-coded fixture list with manifest-driven assertions.
- Modify: `reference/python/tests/test_fixtures.py` — replace hard-coded fixture list with manifest-driven pytest parametrization.
- Modify: `README.md` — add conformance spec link and command.
- Modify: `docs/roadmap.md` — mark Phase 6 conformance levels with concrete files.
- Modify: `reference/typescript/README.md` — document `npm run conformance`.
