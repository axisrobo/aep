...
- Create: `reference/typescript/src/bridge/mcp-aep-consumer.js` — internal helper for MCP calls plus AEP event correlation.
- Create: `reference/typescript/examples/mcp-aep-consumer.js` — runnable demo transcript.
- Create: `reference/typescript/test/mcp-aep-consumer.test.js` — focused behavior tests for the helper.
- Modify: `reference/typescript/package.json` — add `demo:mcp-aep-consumer` script.
- Modify: `README.md` — add root example command.
- Modify: `reference/typescript/README.md` — add example command and scope line.
- Modify: `docs/roadmap.md` — link Phase 4 deliverable to the new example.
