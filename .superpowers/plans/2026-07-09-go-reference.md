...
- Create: `reference/go/go.mod` — module path `github.com/axisrobo/aep`, Go 1.21.
- Create: `reference/go/aep/event_types.go` — standard event type registry.
- Create: `reference/go/aep/errors.go` — error code constants and payload builder.
- Create: `reference/go/aep/envelope.go` — Validates raw envelope maps.
- Create: `reference/go/aep/envelope_test.go` — unit tests for validation.
- Create: `reference/go/aep/router.go` — event router with pattern matching.
- Create: `reference/go/aep/router_test.go` — unit tests for dispatch.
- Create: `reference/go/aep/session.go` — session state machine.
- Create: `reference/go/aep/harness.go` — harness + task tracker, implements C1 behavior.
- Create: `reference/go/aep/harness_test.go` — unit tests for harness (sub, task, session).
- Create: `reference/go/aep/fixtures.go` — manifest and NDJSON loader.
- Create: `reference/go/aep/conformance_test.go` — manifest-driven conformance tests.
- Modify: `reference/go/README.md` — setup/test scope.
- Modify: `README.md` — Go reference status.
- Modify: `docs/roadmap.md` — optional Phase 3 note.
