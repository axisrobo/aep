...
class TestSession:
    def test_lifecycle(self):
        s = AepSession(id="sess_test", heartbeat_interval_ms=0)
        opened = s.opened()
    ...
    def test_rejects_invalid_transitions(self):
        s = AepSession(id="sess_bad", heartbeat_interval_ms=0)
        s.opened()
        s.ready()
        s.close()
    ...
    def test_heartbeat_when_not_ready(self):
        s = AepSession(id="sess_hb", heartbeat_interval_ms=0)
